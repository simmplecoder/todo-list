...
# Template: app
# Command: /home/olzhas/Qt/5.8/gcc_64/bin/qmake -o Makefile todolist.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
SOURCES       = main.cpp \
		mainwindow.cpp \
		addnewdialog.cpp moc_mainwindow.cpp \
...
Makefile: todolist.pro ../../../Qt/5.8/gcc_64/mkspecs/linux-clang/qmake.conf ../../../Qt/5.8/gcc_64/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile todolist.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h addnewdialog.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mainwindow.cpp addnewdialog.cpp $(DISTDIR)/
...
moc_predefs.h: ../../../Qt/5.8/gcc_64/mkspecs/features/data/dummy.cpp
	clang++ -pipe -g -std=gnu++1y -Wall -W -dM -E -o moc_predefs.h ../../../Qt/5.8/gcc_64/mkspecs/features/data/dummy.cpp

compiler_moc_header_make_all: moc_mainwindow.cpp moc_addnewdialog.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_addnewdialog.cpp
